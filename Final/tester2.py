...
# --- Setup ---
# Create a large dummy data file for stress testing.
# We'll create a 1000x50 matrix for a more substantial test.
N = 1000  # Number of data points
d = 50    # Dimension of each data point
test_data = np.random.rand(N, d)
file_name = "stress_test_data.txt"

with open(file_name, "w") as f:
    for row in test_data:
        f.write(",".join(map(str, row)) + "\n")

print(f"Created large dummy data file: {file_name} with {N} data points of dimension {d}\n")
